...
public class ExampleDialogueScript : MonoBehaviour
{
    ...
    public void TestText()
    {
        ...
        dialogueList.Add(new Dialogue { speakerName = "", text = "You wake up to the warm touch of the sunlight and the song of birds singing. Clear skies again." });
        dialogueList.Add(new Dialogue { speakerName = "You", text = "Good morning, world! Another day in Paradise!" });
        dialogueList.Add(new Dialogue { speakerName = "", text = "Egar, you eat breakfast and get cleaned up. Today is a very special day." });
        ...
        dialogueList.Add(new Dialogue { speakerName = "Instructor", text = "For today, why don't you paint some plantlife onto the island. Left-click to draw." });
    ...
    public void GrassPlanted()
    {
        ...
        dialogueList.Add(new Dialogue { speakerName = "", text = "You plant the last of the last of the vegetation and stretch. Done with plenty of time to spare. And so, you saved your work and went to bed." });
    ...
    public void BuildingsAdded(float score)
    {
        ...
        dialogueList.Add(new Dialogue { speakerName = "", text = "... ... ..." });
        dialogueList.Add(new Dialogue { speakerName = "", text = "You wake up the next morning the sun shining in your eyes and to a slight headache. You pull yourself out of bed only to feel a little dizzy. " });
        ...
        dialogueList.Add(new Dialogue { speakerName = "", text = "You rub your eyes to try to stay awake as the headache returns." });
        dialogueList.Add(new Dialogue { speakerName = "", text = "Hopefully, you can get to bed early tonigh. Hopefully..." });
        dialogueList.Add(new Dialogue { speakerName = "", text = "... ... ..." });
    ...
    public void PeopleAdded(SpriteRenderer[] peoples)
    {
        people = peoples;
        List<Dialogue> dialogueList = new List<Dialogue>();
        dialogueList.Add(new Dialogue { speakerName = "You", text = "... ... ..." });
        ...
        dialogueList.Add(new Dialogue { speakerName = "", text = "As you start make stand up, your body feels heavy." });
        dialogueList.Add(new Dialogue { speakerName = "", text = "... ... ..." });
